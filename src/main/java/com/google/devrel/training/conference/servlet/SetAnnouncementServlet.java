...
/**
 * A servlet for putting announcements in memcache. The announcement announces
...
public class SetAnnouncementServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (conferenceNames.size() > 0) {
			...
			String announcementMessage = announcementStringBuilder.toString();

			memcacheService.put(announcementKey, announcementMessage);
		}
